...
void ShowMsgBox(HWND hwnd, MsgboxCallback cb, MsgBoxType type = MT_INFOR,
...
{
public:
	friend void ShowMsgBox(HWND hwnd, MsgboxCallback cb, MsgBoxType type,
...
private:
	...
	void SetButton(const std::wstring &yes, const std::wstring &no, MsgBoxType type = MT_INFOR);
