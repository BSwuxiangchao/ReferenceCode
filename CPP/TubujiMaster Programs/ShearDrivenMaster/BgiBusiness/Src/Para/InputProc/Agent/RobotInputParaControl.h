...
#ifndef _ROBOT_INPUT_PARA_CONTROL_H_
#define _ROBOT_INPUT_PARA_CONTROL_H_

#include "ParaControl.h"

class RobotInputParaControl : public ParaControl
{
public:
    RobotInputParaControl(QString systemId, QString ParaName);
    virtual ~RobotInputParaControl();
